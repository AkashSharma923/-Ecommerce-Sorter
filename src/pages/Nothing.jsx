...
function Nothing() { 
  ...
  return (
    ...
    <div className='text-[40px] bg-[#46753f] w-[60%] rounded-3xl h-[500px] flex justify-between items-center text-center'>
     <div className='w-fit h-full flex justify-center  items-center'><img className='rounded-tl-3xl rounded-bl-3xl w-full h-full ' src="/src/assets/newerror.png" alt="" /></div>

...
function Contact() {
  return (
    <div className='w-[100%] h-[100%] flex  justify-center items-center'>
      <img className='w-[50%] h-[50%]' src="/src/assets/scam2024.gif" alt="" />
      ...
      <audio loop autoPlay src="\src\assets\The Title Track Is As Groovy As The Whole Series  SCAM 1992 - The Harshad Mehta Story.mp3"></audio>
    </div>
  )
}
